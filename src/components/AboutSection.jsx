          ...
          >
            <div className="font-[Poppins] md:max-w-lg space-y-6">
              ...
              <p className="flex items-start text-lg text-muted-foreground">
                <span className="shrink-0 pr-2 text-2xl">👨🏽‍💻</span>
                <span className="flex-1 text-left">
                  Passionate about building software applications with
                  real-world impact.
                </span>
              </p>
              ...
              <p className="flex items-start text-lg text-muted-foreground">
                <span className="shrink-0 pr-2 text-2xl">📝</span>
                <span className="flex-1 text-left">
                  I enjoy the rush of solving a new problem and always having
                  something to learn.
                </span>
              </p>
              ...
              <p className="flex items-start text-lg text-muted-foreground">
                ...
                <span className="flex-1 text-left">
                  Beyond code, I enjoy lifting weights, travelling, and playing
                  video games.
                </span>
              </p>
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              <div className="justify-self-center p-6">
                <div className="grid grid-cols-2 items-center justify-center gap-4">
                  <a
                    href="https://www.linkedin.com/in/ayaanysf"
                    target="_blank"
