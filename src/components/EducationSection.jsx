  ...
  return (
    <div className="relative text-start w-full block">
      <div className="flex justify-between gap-2 items-start">
        ...
        <p className="mt-1 text-sm md:text-base whitespace-nowrap">
          {school.date}
        </p>
      </div>
    ...
    <div className="mb-16 last:mb-0 relative">
      <div className="flex items-start">
        ...
        <div className={cn("hidden md:block w-1/2 pr-8")}>
          {side === "left" && (
            <SpringFade direction="left" delay={0.1} threshold={0.5}>
              <div
                className={cn(
              ...
              >
                ...
                <span
                  className={cn(
                    "absolute top-9 arrow-left scale-x-[-1] -right-[1rem]"
                  )}
                />
        ...
        <SpringGrow>
          <div className="mt-6 md:mt-4 shrink-0 h-12 w-12 mx-[0.1rem] md:mx-auto md:h-16 md:w-16 rounded-full flex items-center justify-center bg-white z-10">
            <img
              src={school.logo}
              alt={school.name}
          ...
          <div className="md:hidden">
            ...
            >
              ...
              >
                ...
                <span
                  className={cn("absolute top-9 arrow-left -left-[1rem]")}
                />
                <CardText school={school} />
              </div>
            </SpringFade>
