    ...
    <section id="projects" className="py-24 px-4 relative">
      <div className="container mx-auto max-w-5xl">
        ...
        <p className="text-center mb-12 text-muted-foreground max-w-2xl mx-auto">
          These are all of my most recent projects. It includes personal projects and academic projects
          where I collaborated with a team. Each project was carefully crafted with attention to detail,
          performance, and the overall user experience.
        </p>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, key) => (
            <div key={key} className="group relative bg-card rounded-lg overflow-hidden shadow-xs card-hover">
